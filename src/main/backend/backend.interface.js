 ...
 *   // setDisplaySettings(deviceId, displayId, s) returns the ApplyResult
 ...
 *   setDisplaySettings(deviceId: number, displayId: number, s: DisplaySettings): Promise<ApplyResult>,
