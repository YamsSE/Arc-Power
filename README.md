...
- **Extended range** - on Alchemist, power limits up to **375 W** and temperature limits up to **115 °C** (elevation prompt + explicit confirm required). Above 315 W the limit applies through the Level Zero sysman power pair (sustained + burst written together); values above the app-verified 375 W ceiling are refused honestly, never clamped.
